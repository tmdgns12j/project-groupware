...
<!-- left box -->
      <div class="mail1-detail">    
         ...
         <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#home">받은메일함</a></li>

         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu1">보낸메일함</a></li>

         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu2">리뷰</a></li>
         </ul>      
   ...
   <div class="mail-send"><h1>받은메일함</h1><br>
