...
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/mail2.css" />
<link rel="stylesheet"
...
<!-- left box -->
   ...
   <div class="mail-send"><h1>받은쪽지함</h1><br>
      <div class="letterwrap">
         ...
         onclick="window.open('<%=request.getContextPath()%>/letter/letterwriteForm','window_name','width=430,height=500,location=no,status=no,scrollbars=yes');"> 
            ...
            <table class="table table-hover">
               ...
               <c:forEach var="l" items="${list}">
                  <c:if test="${l.STF_RCV_SQ eq login}"><!-- id -->
                     <tr><!-- emi_tb -->
